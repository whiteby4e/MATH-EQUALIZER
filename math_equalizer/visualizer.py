...
class Visualizer(FigureCanvas):
    ...
    def __init__(self, parent=None):
        ...
        self.ax_formula.set_xlabel(
            "Time (seconds)"
        )

        self.ax_formula.set_ylabel(
            "Gain"
        )

        self.ax_formula.grid(
            True,
            alpha=0.2
        )
    ...
    def update_formula(
        ...
        self.formula_line.set_data(
            t,
            y
        )

        self.ax_formula.set_xlim(
            t[0],
            t[-1]
        )
